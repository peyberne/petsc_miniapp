...
#    fh.writelines("-ksp_inital_guess_nonzero false\n")

    fh.writelines("EOF\n")
    fh.writelines("   cp mat rhs sol $1\n")
    fh.writelines("   cd $1\n")
    fh.writelines("   srun /scratch/peyberne/petsc_miniapp/solver_for_petsc_param/build/miniapp_solver -mat mat -rhs rhs > log\n")
